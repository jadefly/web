<template>
  <div class="billed-check">
    <div class="checkbills-header">
      <ul>
        <li class="no-wrap">{{checkBilltitle.pointCode}}</li>
            ...
            <li>
              ...
              <em v-if="operationContent.moduleId === 178">
                <img
                  ...
                  src="../images/printer_color.png" alt="">
                <img
                  class="w-20"
  ...
  methods: {
    getData() {
      ...
      ajax('canyin.pos.checkViewBill.view', {
        ...
        // 接口返回的是客位名称.客位编号
        this.checkBilltitle.pointCode = data.pointName;
        this.checkBilltitle.openTime = data.openTime;
        this.checkBilltitle.peopleQty = data.peopleQty;
        this.checkBilltitle.tableQty = data.tableQty;
