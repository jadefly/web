<template>
  <Dialog
    name="PosDialog.PayWayPayoutsModal"
    :title="payWayInfo.name"
    ref="dialog"
    @close="onClose"
    @open="onOpen"
    @submit="onSubmit"
    :hotkeys="PayPayoutsModal"
    :append-to-body="true"
    :showSubmit="true"
    :submit-text="$t('Biz.Settlement.ConfirmAccount')"
    width="800px"
    id="posDialogPayPayoutsModal"
  >
      ...
      <div class="item to-be-pay">
        ...
        <div class="content">
          <span class="line-through">
            <span class="payouts-money">{{amountToBePaid | keepTwo}}</span>
          </span>
        </div>
      </div>
...
export default {
  components: {
    Dialog, KeyBoard, SmsVerificationModal, AndroidInput, BookedSearch,
  },
