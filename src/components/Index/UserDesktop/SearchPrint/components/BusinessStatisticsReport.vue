      ...
      <el-row :gutter="14">
        <div class="table-wrap" v-if="reportData">
          ...
          <table border="1">
            <thead>
            <tr>
              <th colspan="3">{{$t('Biz.UserDesktop.SearchPrint.BusinessStatisticsTh2')}}</th>
            </tr>
            </thead>
            <tbody>
          ...
          <table border="1">
            <thead>
            <tr>
              <th colspan="3">{{$t('Biz.UserDesktop.SearchPrint.BusinessStatisticsTh3')}}</th>
            </tr>
            </thead>
            <tbody>
          ...
          <table border="1">
            <thead>
            <tr>
              <th colspan="3">{{$t('Biz.UserDesktop.SearchPrint.BusinessStatisticsTh4')}}</th>
            </tr>
            </thead>
            <tbody>
          ...
          <table border="1">
            <thead>
            <tr>
              <th colspan="3">{{$t('Biz.UserDesktop.SearchPrint.BusinessStatisticsTh5')}}</th>
            </tr>
            </thead>
            <tbody>
...
export default {
  ...
  mounted() {
    this.$von('searchForXYXBusiness', (data) => {
