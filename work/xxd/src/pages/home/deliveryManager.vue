...
<script>
import { queryProjectSecurityServiceManger } from '@/api/home'
import { mapState, mapGetters } from 'vuex'
import projectdiv from '@/components/home/project.vue'
import assigndiv from '@/components/home/assign.vue'
...
export default {
  ...
  methods: {
    async getIndexData() {
      ...
      const data = await queryProjectSecurityServiceManger(parmas)
